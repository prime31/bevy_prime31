        ...
        impl Ease for $T {
            ...
            fn exponential_in(self) -> Self {
                if self <= 0.0 {
                    ...
                    self::$T::FLOAT_2.powf(10.0 * (self.min(1.0) - 1.0))
                }
            }
            ...
            fn exponential_out(self) -> Self {
                if self >= 1.0 {
                    ...
                    1.0 - self::$T::FLOAT_2.powf(-10.0 * self.max(0.0))
                }
            }
            ...
            fn exponential_in_out(self) -> Self {
                ...
                if self < 0.5 {
                    0.5 * self::$T::FLOAT_2.powf((20.0 * self) - 10.0)
                } else {
                    -0.5 * self::$T::FLOAT_2.powf((-20.0 * self) + 10.0) + 1.0
                }
            }
            ...
            fn elastic_in(self) -> Self {
                use self::$T::PI_2;
                let p = $T::clamp(self);
                (13.0 * PI_2 * p).sin() * self::$T::FLOAT_2.powf(10.0 * (p - 1.0))
            }

            fn elastic_out(self) -> Self {
                use self::$T::PI_2;
                let p = $T::clamp(self);
                (-13.0 * PI_2 * (p + 1.0)).sin() * self::$T::FLOAT_2.powf(-10.0 * p) + 1.0
            }
